...
function GameStartTutN () {
    ...
    story.printDialog("Welcome...", 80, 90, 50, 150)
    story.printDialog("To the Amazing world of ClassyMon!!", 80, 90, 50, 150)
    scene.setBackgroundColor(1)
    pause(500)
    mySprite = sprites.create(assets.image`REPLACEWITHPLAYER`, SpriteKind.Player)
    mySprite.setPosition(22, 21)
    tiles.setCurrentTilemap(tilemap`Room_1`)
    story.printCharacterText("Time to get up!!", "Mom")
    story.spriteSayText(mySprite, "Ugh... Coming Mom!", 8)
    ...
    tiles.connectMapById(tiles.createMap(tilemap`Room_1`), tiles.createMap(tilemap`houseish`), ConnectionKind.Door1)
}
function GameStartTutY () {
    console.log("Complete.")
}
...
scene.setBackgroundImage(img`
    ...
    7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
    `)
let textSprite = textsprite.create("ClassyMon")
textSprite.setMaxFontHeight(24)
textSprite.setPosition(78, 29)
story.showPlayerChoices("Play", "Credits")
if (story.checkLastAnswer("Play")) {
    sprites.destroy(textSprite)
    story.printCharacterText("Do You Want the Tutorial Enabled?", "Tutorial")
